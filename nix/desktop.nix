...
rustPlatform.buildRustPackage (finalAttrs: {
  ...
  preBuild = ''
    ...
    cp ${ironcode}/bin/ironcode packages/desktop/src-tauri/sidecars/ironcode-cli-${stdenv.hostPlatform.rust.rustcTarget}
  '';
  ...
  postFixup = lib.optionalString stdenv.hostPlatform.isLinux ''
    mv $out/bin/IronCode $out/bin/ironcode-desktop
    sed -i 's|^Exec=IronCode$|Exec=ironcode-desktop|' $out/share/applications/IronCode.desktop
  '';
