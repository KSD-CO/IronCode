import { FileDiff, Message, Model, Part, Session, SessionStatus, UserMessage } from "@ironcode-ai/sdk/v2"
import { SessionTurn } from "@ironcode-ai/ui/session-turn"
import { SessionReview } from "@ironcode-ai/ui/session-review"
import { DataProvider } from "@ironcode-ai/ui/context"
import { DiffComponentProvider } from "@ironcode-ai/ui/context/diff"
import { CodeComponentProvider } from "@ironcode-ai/ui/context/code"
import { WorkerPoolProvider } from "@ironcode-ai/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createEffect, createMemo, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@ironcode-ai/ui/logo"
import { IconButton } from "@ironcode-ai/ui/icon-button"
import { ProviderIcon } from "@ironcode-ai/ui/provider-icon"
import { createDefaultOptions } from "@ironcode-ai/ui/pierre"
...
import { MessageNav } from "@ironcode-ai/ui/message-nav"
import { preloadMultiFileDiff, PreloadMultiFileDiffResult } from "@pierre/diffs/ssr"
import { Diff as SSRDiff } from "@ironcode-ai/ui/diff-ssr"
import { clientOnly } from "@solidjs/start"
import { type IconName } from "@ironcode-ai/ui/icons/provider"
import { Meta, Title } from "@solidjs/meta"
import { Base64 } from "js-base64"

const ClientOnlyDiff = clientOnly(() => import("@ironcode-ai/ui/diff").then((m) => ({ default: m.Diff })))
const ClientOnlyCode = clientOnly(() => import("@ironcode-ai/ui/code").then((m) => ({ default: m.Code })))
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@ironcode-ai/ui/pierre/worker").then((m) => ({
      ...
      <Show when={data()}>
        {(data) => {
          ...
          const ogImage = createMemo(() => {
            ...
            return `https://social-cards.sst.dev/ironcode-share/${encodedTitle}.png?model=${modelParam}&version=${version}&id=${data().shareID}`
          })

          return (
            <>
              <Show when={info().title}>
                <Title>{info().title} | IronCode</Title>
              </Show>
              <Meta name="description" content="ironcode - The AI coding agent built for the terminal." />
                          ...
                          <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                            <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                              ...
                              <div class="flex gap-3 items-center">
                                <IconButton
                                  as={"a"}
                                  href="https://github.com/anomalyco/ironcode"
                                  target="_blank"
                                  icon="github"
                                  variant="ghost"
                                />
                                <IconButton
                                  as={"a"}
                                  href="https://ironcode.ai/discord"
                                  target="_blank"
                                  icon="discord"
                                  variant="ghost"
                                />
