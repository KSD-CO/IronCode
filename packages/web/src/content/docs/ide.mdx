---
title: IDE
description: The IronCode extension for VS Code, Cursor, and other IDEs
---

IronCode integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `ironcode` in the terminal to get started.
...
To install IronCode on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `ironcode` - the extension installs automatically
...
Search for **IronCode** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `ironcode` in the integrated terminal.
