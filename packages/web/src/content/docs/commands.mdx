...
Create `.ironcode/commands/test.md`:

```md title=".ironcode/commands/test.md"
---
...
You can add custom commands through the IronCode config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your IronCode [config](/docs/config):

```json title="ironcode.jsonc" {4-12}
{
...
- Global: `~/.config/ironcode/commands/`
- Per-project: `.ironcode/commands/`

```markdown title="~/.config/ironcode/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".ironcode/commands/component.md"
---
...
```md title=".ironcode/commands/create-file.md"
---
...
```md title=".ironcode/commands/analyze-coverage.md"
---
...
```md title=".ironcode/commands/review-changes.md"
---
...
```md title=".ironcode/commands/review-component.md"
---
...
ironcode includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
