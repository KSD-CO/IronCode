---
title: LSP Servers
description: IronCode integrates with your LSP servers.
---

IronCode integrates with your Language Server Protocol (LSP) to help the LLM interact with your codebase. It uses diagnostics to provide feedback to the LLM.

---

## Built-in

IronCode comes with several built-in LSP servers for popular languages:
...
:::note
You can disable automatic LSP server downloads by setting the `IRONCODE_DISABLE_LSP_DOWNLOAD` environment variable to `true`.
:::
...
You can customize LSP servers through the `lsp` section in your ironcode config.
