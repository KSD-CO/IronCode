---
title: TUI
description: Using the IronCode terminal user interface.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

IronCode provides an interactive terminal interface or TUI for working on your projects with an LLM.

Running IronCode starts the TUI for the current directory.
...
When using the IronCode TUI, you can type `/` followed by a command name to quickly execute actions. For example:
...
Add a provider to IronCode. Allows you to select from available providers and add their API keys.
...
Exit IronCode. _Aliases_: `/quit`, `/q`
...
You can customize TUI behavior through your IronCode config file.
