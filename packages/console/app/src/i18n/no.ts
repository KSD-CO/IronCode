...
export const dict = {
  ...
  "notFound.title": "Ikke funnet | ironcode",
  ...
  "home.title": "IronCode | Den apne kildekode AI-kodingsagenten",
  ...
  "home.what.title": "Hva er IronCode?",
  "home.what.body": "IronCode er en apen kildekode-agent som hjelper deg a skrive kode i terminal, IDE eller desktop.",
  ...
  "home.growth.body":
    "Med over <strong>{{stars}}</strong> GitHub-stjerner, <strong>{{contributors}}</strong> bidragsytere og over <strong>{{commits}}</strong> commits, brukes IronCode av over <strong>{{monthlyUsers}}</strong> utviklere hver maned.",
  ...
  "home.privacy.body":
    "IronCode lagrer ikke koden din eller kontekstdata, slik at den kan fungere i personvernsensitive miljoer.",
  "home.privacy.learnMore": "Les mer om",
  "home.privacy.link": "personvern",

  "home.faq.q1": "Hva er IronCode?",
  "home.faq.a1":
    "IronCode er en apen kildekode-agent som hjelper deg a skrive og kjore kode med hvilken som helst AI-modell. Den er tilgjengelig som terminalgrensesnitt, desktop-app eller IDE-utvidelse.",
  "home.faq.q2": "Hvordan bruker jeg IronCode?",
  "home.faq.a2.before": "Den enkleste maten a komme i gang pa er a lese",
  "home.faq.a2.link": "introen",
  "home.faq.q3": "Trenger jeg ekstra AI-abonnementer for a bruke IronCode?",
  "home.faq.a3.p1": "Ikke nodvendigvis. IronCode kommer med gratis modeller du kan bruke uten a opprette en konto.",
  "home.faq.a3.p2.beforeZen": "I tillegg kan du bruke populære kodemodeller ved a opprette en",
  "home.faq.a3.p2.afterZen": " konto.",
  "home.faq.a3.p3":
    "Vi oppfordrer til a bruke Zen, men IronCode fungerer ogsa med populære leverandorer som OpenAI, Anthropic, xAI osv.",
  "home.faq.a3.p4.beforeLocal": "Du kan til og med koble til dine",
  "home.faq.a3.p4.localLink": "lokale modeller",
  "home.faq.q4": "Kan jeg bruke mine eksisterende AI-abonnementer med IronCode?",
  "home.faq.a4.p1":
    "Ja. IronCode stotter abonnementer fra alle store leverandorer. Du kan bruke Claude Pro/Max, ChatGPT Plus/Pro eller GitHub Copilot.",
  "home.faq.q5": "Kan jeg bare bruke IronCode i terminalen?",
  "home.faq.a5.beforeDesktop": "Ikke lenger! IronCode er na tilgjengelig som en app for",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "og",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Hva koster IronCode?",
  "home.faq.a6":
    "IronCode er 100% gratis a bruke. Det kommer ogsa med et sett gratis modeller. Det kan vare ekstra kostnader hvis du kobler til en annen leverandor.",
  ...
  "home.faq.q8": "Er IronCode apen kildekode?",
  "home.faq.a8.p1": "Ja, IronCode er fullt open source. Kildekoden er offentlig pa",
  ...
  "home.zenCta.body":
    "Zen gir deg tilgang til et handplukket sett med AI-modeller som IronCode har testet og benchmarked spesielt for kodingsagenter. Du slipper a bekymre deg for ujevn ytelse og kvalitet pa tvers av leverandorer: bruk validerte modeller som fungerer.",
  "home.zenCta.link": "Les om Zen",

  "download.title": "IronCode | Nedlasting",

  "zen.title": "IronCode Zen | Et kuratert sett med palitelige, optimaliserte modeller for kodingsagenter",
  "zen.hero.title": "Fa tilgang til palitelige, optimaliserte modeller for kodingsagenter",
  "zen.hero.body":
    "Zen gir deg tilgang til et handplukket sett med AI-modeller som IronCode har testet og benchmarked spesielt for kodingsagenter. Du slipper a bekymre deg for ujevn ytelse og kvalitet pa tvers av leverandorer: bruk validerte modeller som fungerer.",

  "zen.faq.q1": "Hva er IronCode Zen?",
  "zen.faq.a1":
    "Zen er et kuratert sett med AI-modeller testet og benchmarked for kodingsagenter, laget av teamet bak IronCode.",
  ...
  "zen.faq.a3":
    "Zen er ikke for profitt. Zen videreformidler kostnadene fra modellleverandorene direkte til deg. Jo mer Zen brukes, desto mer kan IronCode forhandle bedre priser og gi dem videre til deg.",
  ...
  "zen.faq.a4.p3":
    "For a dekke kostnader legger IronCode til bare en liten betalingsbehandlingsavgift pa $1.23 per $20 saldo-pafyll.",
  ...
  "zen.faq.a8":
    "Zen fungerer veldig bra med IronCode, men du kan bruke Zen med hvilken som helst agent. Folg oppsettinstruksjonene i din foretrukne kodingsagent.",
  ...
  "zen.problem.subtitle": "Vi fikser dette for alle, ikke bare IronCode-brukere.",
  ...
  "zen.how.body": "Selv om vi foreslår at du bruker Zen med IronCode, kan du bruke Zen med hvilken som helst agent.",
  ...
  "download.meta.description": "Last ned IronCode for macOS, Windows og Linux",
  "download.hero.title": "Last ned IronCode",
  ...
  "download.faq.a3.beforeLocal":
    "Ikke nodvendigvis, men sannsynligvis. Du trenger et AI-abonnement hvis du vil koble IronCode til en betalt leverandor, men du kan jobbe med",
  ...
  "download.faq.a3.afterZen": ", fungerer IronCode med alle populære leverandorer som OpenAI, Anthropic, xAI osv.",

  "download.faq.a5.p1": "IronCode er 100% gratis a bruke.",
  "download.faq.a5.p2.beforeZen":
    "Eventuelle ekstra kostnader kommer fra abonnementet ditt hos en modellleverandor. Selv om IronCode fungerer med enhver modellleverandor, anbefaler vi a bruke",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Dataene og informasjonen din lagres bare nar du oppretter delbare lenker i IronCode.",
  "download.faq.a6.p2.beforeShare": "Les mer om",
  "download.faq.a6.shareLink": "delingssider",

  "enterprise.title": "IronCode | Enterprise-losninger for din organisasjon",
  "enterprise.meta.description": "Kontakt IronCode for enterprise-losninger",
  "enterprise.hero.title": "Koden din er din",
  "enterprise.hero.body1":
    "IronCode opererer sikkert inne i organisasjonen din uten at data eller kontekst lagres, og uten lisensbegrensninger eller eierskapskrav. Start en proveperiode med teamet ditt, og rull den deretter ut i hele organisasjonen ved a integrere den med SSO-en din og den interne AI-gatewayen.",
  ...
  "enterprise.faq.q1": "Hva er IronCode Enterprise?",
  "enterprise.faq.a1":
    "IronCode Enterprise er for organisasjoner som vil sikre at koden og dataene deres aldri forlater infrastrukturen deres. Dette kan gjores med en sentral konfigurasjon som integreres med SSO-en din og den interne AI-gatewayen.",
  "enterprise.faq.q2": "Hvordan kommer jeg i gang med IronCode Enterprise?",
  "enterprise.faq.a2":
    "Start enkelt med en intern proveperiode med teamet ditt. IronCode lagrer som standard ikke koden din eller kontekstdata, noe som gjor det enkelt a komme i gang. Kontakt oss deretter for a diskutere priser og implementeringsalternativer.",
  ...
  "enterprise.faq.q4": "Er dataene mine sikre med IronCode Enterprise?",
  "enterprise.faq.a4":
    "Ja. IronCode lagrer ikke koden din eller kontekstdata. All behandling skjer lokalt eller gjennom direkte API-kall til AI-leverandoren din. Med sentral konfigurasjon og SSO-integrasjon forblir dataene dine sikre innenfor organisasjonens infrastruktur.",

  "brand.title": "IronCode | Brand",
  "brand.meta.description": "IronCode retningslinjer for merkevaren",
  "brand.heading": "Retningslinjer for merkevaren",
  "brand.subtitle": "Ressurser og assets som hjelper deg å jobbe med IronCode-brandet.",
  "brand.downloadAll": "Last ned alle assets",
  "changelog.title": "IronCode | Endringslogg",
  "changelog.meta.description": "Utgivelsesnotater og endringslogg for IronCode",
  "changelog.hero.title": "Endringslogg",
  "changelog.hero.subtitle": "Nye oppdateringer og forbedringer for IronCode",
  ...
  "workspace.newUser.feature.lockin.body":
    "Bruk Zen med hvilken som helst kodeagent, og fortsett å bruke andre leverandører med ironcode når du vil.",
  ...
  "workspace.newUser.step.login.after": "og velg ironcode",
  "workspace.newUser.step.pasteKey": "Lim inn API-nøkkelen",
  "workspace.newUser.step.models.before": "Start ironcode og kjør",
  ...
  "workspace.keys.subtitle": "Administrer API-nøklene dine for å få tilgang til ironcode-tjenester.",
  "workspace.keys.create": "Opprett API-nøkkel",
  "workspace.keys.placeholder": "Skriv inn nøkkelnavn",
  "workspace.keys.empty": "Opprett en ironcode Gateway API nøkkel",
  ...
  "workspace.black.subscription.message": "Du abonnerer på IronCode Black for ${{plan}} per måned.",
  ...
  "workspace.black.waitlist.joined": "Du er på ventelisten for ${{plan}} per måned IronCode Black plan.",
  "workspace.black.waitlist.ready": "Vi er klare til å melde deg på ${{plan}} per måned IronCode Black plan.",
