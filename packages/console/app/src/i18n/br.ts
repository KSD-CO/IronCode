...
export const dict = {
  ...
  "notFound.title": "Nao encontrado | ironcode",
  ...
  "home.title": "IronCode | O agente de codificacao com IA de codigo aberto",
  ...
  "home.what.title": "O que e IronCode?",
  "home.what.body":
    "IronCode e um agente de codigo aberto que ajuda voce a escrever codigo no terminal, IDE ou desktop.",
  ...
  "home.growth.body":
    "Com mais de <strong>{{stars}}</strong> estrelas no GitHub, <strong>{{contributors}}</strong> colaboradores e mais de <strong>{{commits}}</strong> commits, IronCode e usado e confiado por mais de <strong>{{monthlyUsers}}</strong> desenvolvedores todos os meses.",
  ...
  "home.privacy.body":
    "IronCode nao armazena nenhum codigo seu nem dados de contexto, para poder operar em ambientes sensiveis a privacidade.",
  "home.privacy.learnMore": "Saiba mais sobre",
  "home.privacy.link": "privacidade",

  "home.faq.q1": "O que e IronCode?",
  "home.faq.a1":
    "IronCode e um agente de codigo aberto que ajuda voce a escrever e executar codigo com qualquer modelo de IA. Ele esta disponivel como interface de terminal, app desktop ou extensao de IDE.",
  "home.faq.q2": "Como eu uso o IronCode?",
  "home.faq.a2.before": "A forma mais facil de comecar e ler a",
  "home.faq.a2.link": "introducao",
  "home.faq.q3": "Preciso de assinaturas extras de IA para usar o IronCode?",
  "home.faq.a3.p1":
    "Nao necessariamente, IronCode vem com um conjunto de modelos gratis que voce pode usar sem criar conta.",
  "home.faq.a3.p2.beforeZen": "Fora isso, voce pode usar modelos populares para codigo criando uma conta",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Embora incentivemos os usuarios a usar o Zen, IronCode tambem funciona com todos os provedores populares, como OpenAI, Anthropic, xAI etc.",
  "home.faq.a3.p4.beforeLocal": "Voce pode ate conectar seus",
  "home.faq.a3.p4.localLink": "modelos locais",
  "home.faq.q4": "Posso usar minhas assinaturas de IA existentes com o IronCode?",
  "home.faq.a4.p1":
    "Sim, IronCode oferece suporte a planos de assinatura dos principais provedores. Voce pode usar suas assinaturas Claude Pro/Max, ChatGPT Plus/Pro ou GitHub Copilot.",
  "home.faq.q5": "Posso usar o IronCode apenas no terminal?",
  "home.faq.a5.beforeDesktop": "Nao mais! IronCode agora esta disponivel como um app para o",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "e",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Quanto custa o IronCode?",
  "home.faq.a6":
    "IronCode e 100% gratis para usar. Tambem vem com um conjunto de modelos gratuitos. Pode haver custos adicionais se voce conectar outro provedor.",
  ...
  "home.faq.q8": "IronCode e codigo aberto?",
  "home.faq.a8.p1": "Sim, IronCode e totalmente open source. O codigo-fonte e publico no",
  ...
  "home.zenCta.body":
    "O Zen te da acesso a um conjunto selecionado de modelos de IA que a IronCode testou e benchmarkou especificamente para agentes de codigo. Nao precisa se preocupar com desempenho e qualidade inconsistentes entre provedores: use modelos validados que funcionam.",
  "home.zenCta.link": "Saiba mais sobre o Zen",

  "download.title": "IronCode | Download",

  "zen.title": "IronCode Zen | Um conjunto selecionado de modelos confiaveis e otimizados para agentes de codigo",
  "zen.hero.title": "Acesse modelos confiaveis e otimizados para agentes de codigo",
  "zen.hero.body":
    "O Zen te da acesso a um conjunto selecionado de modelos de IA que a IronCode testou e benchmarkou especificamente para agentes de codigo. Nao precisa se preocupar com desempenho e qualidade inconsistentes entre provedores: use modelos validados que funcionam.",

  "zen.faq.q1": "O que e IronCode Zen?",
  "zen.faq.a1":
    "Zen e um conjunto selecionado de modelos de IA testados e benchmarkados para agentes de codigo, criado pelo time por tras do IronCode.",
  ...
  "zen.faq.a3":
    "Zen nao tem fins lucrativos. Zen repassa os custos dos provedores de modelos diretamente para voce. Quanto maior o uso do Zen, mais a IronCode pode negociar melhores taxas e repassar para voce.",
  ...
  "zen.faq.a4.p3":
    "Para cobrir custos, a IronCode adiciona apenas uma pequena taxa de processamento de pagamento de $1.23 por recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Embora o Zen funcione muito bem com o IronCode, voce pode usar o Zen com qualquer agente. Siga as instrucoes de configuracao no seu agente de codigo preferido.",
  ...
  "zen.problem.subtitle": "Estamos corrigindo isso para todos, não apenas para os usuários IronCode.",
  ...
  "zen.how.body": "Embora sugerimos que você use Zen com IronCode, você pode usar Zen com qualquer agente.",
  ...
  "download.meta.description": "Baixe o IronCode para macOS, Windows e Linux",
  "download.hero.title": "Baixar IronCode",
  ...
  "download.section.extensions": "Extensoes do IronCode",
  "download.section.integrations": "Integracoes do IronCode",
  ...
  "download.faq.a3.beforeLocal":
    "Nao necessariamente, mas provavelmente. Voce vai precisar de uma assinatura de IA se quiser conectar o IronCode a um provedor pago, embora possa trabalhar com",
  ...
  "download.faq.a3.afterZen":
    ", o IronCode funciona com todos os provedores populares como OpenAI, Anthropic, xAI etc.",

  "download.faq.a5.p1": "IronCode e 100% gratuito para usar.",
  "download.faq.a5.p2.beforeZen":
    "Qualquer custo adicional vira da sua assinatura de um provedor de modelos. Embora o IronCode funcione com qualquer provedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Seus dados e informacoes so sao armazenados quando voce cria links compartilhaveis no IronCode.",
  "download.faq.a6.p2.beforeShare": "Saiba mais sobre",
  "download.faq.a6.shareLink": "paginas de compartilhamento",

  "enterprise.title": "IronCode | Solucoes empresariais para sua organizacao",
  "enterprise.meta.description": "Entre em contato com a IronCode para solucoes empresariais",
  "enterprise.hero.title": "Seu codigo e seu",
  "enterprise.hero.body1":
    "A IronCode opera de forma segura dentro da sua organizacao sem armazenar dados ou contexto e sem restricoes de licenca ou reivindicacoes de propriedade. Inicie um teste com sua equipe e, em seguida, implante em toda a organizacao integrando com seu SSO e gateway interno de IA.",
  ...
  "enterprise.faq.q1": "O que e IronCode Enterprise?",
  "enterprise.faq.a1":
    "IronCode Enterprise e para organizacoes que querem garantir que seu codigo e dados nunca saiam da sua infraestrutura. Isso pode ser feito com uma configuracao centralizada que se integra ao seu SSO e gateway interno de IA.",
  "enterprise.faq.q2": "Como comeco com IronCode Enterprise?",
  "enterprise.faq.a2":
    "Basta comecar com um teste interno com sua equipe. A IronCode por padrao nao armazena seu codigo nem dados de contexto, tornando facil comecar. Depois, entre em contato conosco para discutir precos e opcoes de implementacao.",
  ...
  "enterprise.faq.q4": "Meus dados estao seguros com IronCode Enterprise?",
  "enterprise.faq.a4":
    "Sim. A IronCode nao armazena seu codigo nem dados de contexto. Todo o processamento acontece localmente ou por chamadas diretas de API ao seu provedor de IA. Com configuracao centralizada e integracao SSO, seus dados permanecem seguros dentro da infraestrutura da sua organizacao.",

  "brand.title": "IronCode | Marca",
  "brand.meta.description": "Diretrizes de marca da IronCode",
  "brand.heading": "Diretrizes de marca",
  "brand.subtitle": "Recursos e arquivos para ajudar você a trabalhar com a marca IronCode.",
  "brand.downloadAll": "Baixar todos os assets",
  "changelog.title": "IronCode | Registro de mudancas",
  "changelog.meta.description": "Notas de versao e registro de mudancas do IronCode",
  "changelog.hero.title": "Registro de mudancas",
  "changelog.hero.subtitle": "Novas atualizacoes e melhorias no IronCode",
  ...
  "workspace.newUser.feature.lockin.body":
    "Use Zen com qualquer agente de codificação e continue usando outros provedores com ironcode sempre que quiser.",
  ...
  "workspace.newUser.step.login.after": "e selecione ironcode",
  "workspace.newUser.step.pasteKey": "Cole sua chave API",
  "workspace.newUser.step.models.before": "Inicie ironcode e execute",
  ...
  "workspace.keys.subtitle": "Gerencie suas chaves API para acessar serviços ironcode.",
  "workspace.keys.create": "Criar chave API",
  "workspace.keys.placeholder": "Digite o nome da chave",
  "workspace.keys.empty": "Crie uma chave ironcode Gateway API",
  ...
  "workspace.black.subscription.message": "Você está inscrito no IronCode Black por ${{plan}} por mês.",
  ...
  "workspace.black.waitlist.joined": "Você está na lista de espera do plano Black de ${{plan}} por mês IronCode.",
  "workspace.black.waitlist.ready": "Estamos prontos para inscrevê-lo no plano Black de ${{plan}} por mês IronCode.",
