...
export const dict = {
  ...
  "notFound.title": "Nie znaleziono | ironcode",
  ...
  "home.title": "IronCode | Open source AI agent do kodowania",
  ...
  "home.what.title": "Czym jest IronCode?",
  "home.what.body": "IronCode to open source agent, ktory pomaga pisac kod w terminalu, IDE lub na desktopie.",
  ...
  "home.growth.body":
    "Ponad <strong>{{stars}}</strong> gwiazdek na GitHub, <strong>{{contributors}}</strong> wspoltworcow i ponad <strong>{{commits}}</strong> commitow - IronCode jest uzywany i ceniony przez ponad <strong>{{monthlyUsers}}</strong> deweloperow co miesiac.",
  ...
  "home.privacy.body":
    "IronCode nie przechowuje Twojego kodu ani danych kontekstowych, dzieki czemu moze dzialac w srodowiskach wrazliwych na prywatnosc.",
  "home.privacy.learnMore": "Dowiedz sie wiecej o",
  "home.privacy.link": "prywatnosci",

  "home.faq.q1": "Czym jest IronCode?",
  "home.faq.a1":
    "IronCode to open source agent, ktory pomaga pisac i uruchamiac kod z dowolnym modelem AI. Jest dostepny jako interfejs terminalowy, aplikacja desktopowa lub rozszerzenie IDE.",
  "home.faq.q2": "Jak korzystac z IronCode?",
  "home.faq.a2.before": "Najlatwiej zaczac od przeczytania",
  "home.faq.a2.link": "wprowadzenia",
  "home.faq.q3": "Czy potrzebuje dodatkowych subskrypcji AI, aby uzywac IronCode?",
  "home.faq.a3.p1":
    "Niekoniecznie. IronCode ma zestaw darmowych modeli, z ktorych mozesz korzystac bez zakladania konta.",
  "home.faq.a3.p2.beforeZen": "Poza tym mozesz uzywac popularnych modeli do kodowania tworzac konto",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Choc zachecamy do Zen, IronCode dziala tez z popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itd.",
  "home.faq.a3.p4.beforeLocal": "Mozesz nawet podlaczyc swoje",
  "home.faq.a3.p4.localLink": "modele lokalne",
  "home.faq.q4": "Czy moge uzywac moich istniejacych subskrypcji AI z IronCode?",
  "home.faq.a4.p1":
    "Tak. IronCode wspiera subskrypcje u wszystkich glownych dostawcow. Mozesz uzywac Claude Pro/Max, ChatGPT Plus/Pro lub GitHub Copilot.",
  "home.faq.q5": "Czy moge uzywac IronCode tylko w terminalu?",
  "home.faq.a5.beforeDesktop": "Juz nie! IronCode jest teraz dostepny jako aplikacja na",
  "home.faq.a5.desktop": "desktop",
  "home.faq.a5.and": "i",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Ile kosztuje IronCode?",
  "home.faq.a6":
    "IronCode jest w 100% darmowy. Zawiera tez zestaw darmowych modeli. Moga pojawic sie dodatkowe koszty, jesli podlaczysz innego dostawce.",
  ...
  "home.faq.q8": "Czy IronCode jest open source?",
  "home.faq.a8.p1": "Tak, IronCode jest w pelni open source. Kod zrodlowy jest publiczny na",
  ...
  "home.zenCta.body":
    "Zen daje dostep do wyselekcjonowanego zestawu modeli AI, ktore IronCode przetestowal i zbenchmarkowal specjalnie dla agentow kodowania. Nie musisz martwic sie o niespojne wyniki i jakosc miedzy dostawcami - uzywaj zweryfikowanych modeli, ktore dzialaja.",
  "home.zenCta.link": "Dowiedz sie o Zen",

  "download.title": "IronCode | Pobieranie",

  "zen.title": "IronCode Zen | Wyselekcjonowany zestaw niezawodnych, zoptymalizowanych modeli dla agentow kodowania",
  "zen.hero.title": "Uzyskaj dostep do niezawodnych, zoptymalizowanych modeli dla agentow kodowania",
  "zen.hero.body":
    "Zen daje dostep do wyselekcjonowanego zestawu modeli AI, ktore IronCode przetestowal i zbenchmarkowal specjalnie dla agentow kodowania. Nie musisz martwic sie o niespojne wyniki i jakosc miedzy dostawcami - uzywaj zweryfikowanych modeli, ktore dzialaja.",

  "zen.faq.q1": "Czym jest IronCode Zen?",
  "zen.faq.a1":
    "Zen to wyselekcjonowany zestaw modeli AI przetestowanych i zbenchmarkowanych pod agentow kodowania, stworzony przez zespol stojacy za IronCode.",
  ...
  "zen.faq.a3":
    "Zen nie jest nastawiony na zysk. Zen przekazuje koszty dostawcow modeli bezposrednio do Ciebie. Im wieksze uzycie Zen, tym bardziej IronCode moze negocjowac lepsze stawki i przekazywac je Tobie.",
  ...
  "zen.faq.a4.p3":
    "Aby pokryc koszty, IronCode dodaje tylko niewielka oplate za przetwarzanie platnosci w wysokosci $1.23 za kazde doladowanie salda $20.",
  ...
  "zen.faq.a8":
    "Zen swietnie dziala z IronCode, ale mozesz uzywac Zen z dowolnym agentem. Postepuj zgodnie z instrukcjami konfiguracji w swoim ulubionym agencie kodowania.",
  ...
  "zen.problem.subtitle": "Naprawiamy to dla wszystkich, nie tylko dla użytkowników IronCode.",
  ...
  "zen.how.body": "Chociaż sugerujemy używanie Zen z IronCode, możesz używać Zen z dowolnym agentem.",
  ...
  "download.meta.description": "Pobierz IronCode dla macOS, Windows i Linux",
  "download.hero.title": "Pobierz IronCode",
  ...
  "download.section.extensions": "Rozszerzenia IronCode",
  "download.section.integrations": "Integracje IronCode",
  ...
  "download.faq.a3.beforeLocal":
    "Niekoniecznie, ale prawdopodobnie. Potrzebujesz subskrypcji AI, jesli chcesz podlaczyc IronCode do platnego dostawcy, ale mozesz korzystac z",
  ...
  "download.faq.a3.afterZen":
    ", IronCode dziala ze wszystkimi popularnymi dostawcami, takimi jak OpenAI, Anthropic, xAI itd.",

  "download.faq.a5.p1": "IronCode jest w 100% darmowy.",
  "download.faq.a5.p2.beforeZen":
    "Wszelkie dodatkowe koszty wynikaja z Twojej subskrypcji u dostawcy modeli. IronCode dziala z kazdym dostawca modeli, ale polecamy korzystac z",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1":
    "Twoje dane i informacje sa przechowywane tylko gdy tworzysz linki do udostepniania w IronCode.",
  "download.faq.a6.p2.beforeShare": "Dowiedz sie wiecej o",
  "download.faq.a6.shareLink": "stronach udostepniania",

  "enterprise.title": "IronCode | Rozwiazania enterprise dla twojej organizacji",
  "enterprise.meta.description": "Skontaktuj sie z IronCode w sprawie rozwiazan enterprise",
  "enterprise.hero.title": "Twoj kod nalezy do Ciebie",
  "enterprise.hero.body1":
    "IronCode dziala bezpiecznie w obrebie Twojej organizacji, nie przechowuje danych ani kontekstu oraz nie narzuca ograniczen licencyjnych ani roszczen do wlasnosci. Rozpocznij okres probny z zespolem, a nastepnie wdroz IronCode w calej organizacji, integrujac go z Twoim SSO i wewnetrzna brama AI.",
  ...
  "enterprise.faq.q1": "Czym jest IronCode Enterprise?",
  "enterprise.faq.a1":
    "IronCode Enterprise jest dla organizacji, ktore chca miec pewnosc, ze ich kod i dane nigdy nie opuszcza ich infrastruktury. Osiaga to dzieki scentralizowanej konfiguracji, ktora integruje sie z Twoim SSO i wewnetrzna brama AI.",
  "enterprise.faq.q2": "Jak zaczac korzystac z IronCode Enterprise?",
  "enterprise.faq.a2":
    "Po prostu zacznij od wewnetrznego okresu probnego z Twoim zespolem. IronCode domyslnie nie przechowuje Twojego kodu ani danych kontekstowych, dzieki czemu latwo zaczac. Nastepnie skontaktuj sie z nami, aby omowic ceny i opcje wdrozenia.",
  ...
  "enterprise.faq.q4": "Czy moje dane sa bezpieczne z IronCode Enterprise?",
  "enterprise.faq.a4":
    "Tak. IronCode nie przechowuje Twojego kodu ani danych kontekstowych. Cale przetwarzanie odbywa sie lokalnie lub poprzez bezposrednie wywolania API do Twojego dostawcy AI. Dzieki scentralizowanej konfiguracji i integracji SSO Twoje dane pozostaja bezpieczne w obrebie infrastruktury Twojej organizacji.",

  "brand.title": "IronCode | Marka",
  "brand.meta.description": "Wytyczne marki IronCode",
  "brand.heading": "Wytyczne marki",
  "brand.subtitle": "Zasoby i materialy, ktore pomoga Ci pracowac z marka IronCode.",
  "brand.downloadAll": "Pobierz wszystkie materialy",
  "changelog.title": "IronCode | Dziennik zmian",
  "changelog.meta.description": "Informacje o wydaniach i dziennik zmian IronCode",
  "changelog.hero.title": "Dziennik zmian",
  "changelog.hero.subtitle": "Nowe aktualizacje i ulepszenia IronCode",
  ...
  "workspace.newUser.feature.lockin.body":
    "Używaj Zen z dowolnym agentem kodującym i kontynuuj korzystanie z innych dostawców z ironcode, kiedy tylko chcesz.",
  ...
  "workspace.newUser.step.login.after": "i wybierz ironcode",
  "workspace.newUser.step.pasteKey": "Wklej swój klucz API",
  "workspace.newUser.step.models.before": "Uruchom ironcode i uruchom",
  ...
  "workspace.keys.subtitle": "Zarządzaj kluczami API umożliwiającymi dostęp do usług ironcode.",
  "workspace.keys.create": "Utwórz klucz API",
  "workspace.keys.placeholder": "Wprowadź nazwę klucza",
  "workspace.keys.empty": "Utwórz klucz ironcode bramy API",
  ...
  "workspace.black.subscription.message": "Subskrybujesz IronCode Black za {{plan}} miesięcznie.",
  ...
  "workspace.black.waitlist.joined": "Jesteś na liście oczekujących na plan ${{plan}} miesięcznie IronCode Black.",
  "workspace.black.waitlist.ready":
    "Jesteśmy gotowi zapisać Cię do planu Black o wartości {{plan}} miesięcznie IronCode.",
