...
export const dict = {
  ...
  "notFound.title": "No encontrado | ironcode",
  ...
  "home.title": "IronCode | El agente de codificacion con IA de codigo abierto",
  ...
  "home.what.title": "Que es IronCode?",
  "home.what.body":
    "IronCode es un agente de codigo abierto que te ayuda a escribir codigo en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con mas de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y mas de <strong>{{commits}}</strong> commits, IronCode es usado y confiado por mas de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "IronCode no almacena tu codigo ni datos de contexto, para poder operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Mas informacion sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "Que es IronCode?",
  "home.faq.a1":
    "IronCode es un agente de codigo abierto que te ayuda a escribir y ejecutar codigo con cualquier modelo de IA. Esta disponible como interfaz de terminal, app de escritorio o extension de IDE.",
  "home.faq.q2": "Como uso IronCode?",
  "home.faq.a2.before": "La forma mas facil de empezar es leer la",
  "home.faq.a2.link": "introduccion",
  "home.faq.q3": "Necesito suscripciones extra de IA para usar IronCode?",
  "home.faq.a3.p1":
    "No necesariamente: IronCode incluye un conjunto de modelos gratis que puedes usar sin crear una cuenta.",
  "home.faq.a3.p2.beforeZen": "Ademas, puedes usar modelos populares para codigo creando una cuenta de",
  "home.faq.a3.p2.afterZen": ".",
  "home.faq.a3.p3":
    "Aunque alentamos a los usuarios a usar Zen, IronCode tambien funciona con los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "Puedo usar mis suscripciones de IA existentes con IronCode?",
  "home.faq.a4.p1":
    "Si, IronCode admite planes de suscripcion de los principales proveedores. Puedes usar Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "Solo puedo usar IronCode en la terminal?",
  "home.faq.a5.beforeDesktop": "Ya no! IronCode ahora esta disponible como una app para",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "Cuanto cuesta IronCode?",
  "home.faq.a6":
    "IronCode es 100% gratis. Tambien incluye modelos gratuitos. Puede haber costos adicionales si conectas otro proveedor.",
  ...
  "home.faq.q8": "IronCode es de codigo abierto?",
  "home.faq.a8.p1": "Si, IronCode es totalmente open source. El codigo fuente es publico en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que IronCode ha probado y benchmarkeado especificamente para agentes de codigo. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores: usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "download.title": "IronCode | Descargar",

  "zen.title": "IronCode Zen | Un conjunto seleccionado de modelos confiables y optimizados para agentes de codigo",
  "zen.hero.title": "Accede a modelos confiables y optimizados para agentes de codigo",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que IronCode ha probado y benchmarkeado especificamente para agentes de codigo. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores: usa modelos validados que funcionan.",

  "zen.faq.q1": "Que es IronCode Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y benchmarkeados para agentes de codigo, creado por el equipo detras de IronCode.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen traslada los costos de los proveedores de modelos directamente a ti. Cuanto mas uso tenga Zen, mas puede IronCode negociar mejores tarifas y trasladartelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, IronCode solo agrega una pequena tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona muy bien con IronCode, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuracion en tu agente preferido.",
  ...
  "zen.problem.subtitle": "Estamos solucionando este problema para todos, no solo para los usuarios de IronCode.",
  ...
  "zen.how.body": "Si bien le sugerimos que utilice Zen con IronCode, puede utilizar Zen con cualquier agente.",
  ...
  "download.meta.description": "Descarga IronCode para macOS, Windows y Linux",
  "download.hero.title": "Descargar IronCode",
  ...
  "download.section.extensions": "Extensiones de IronCode",
  "download.section.integrations": "Integraciones de IronCode",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitaras una suscripcion de IA si quieres conectar IronCode a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", IronCode funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "IronCode es 100% gratis.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendra de tu suscripcion a un proveedor de modelos. Aunque IronCode funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e informacion solo se almacenan cuando creas enlaces compartibles en IronCode.",
  "download.faq.a6.p2.beforeShare": "Mas informacion sobre",
  "download.faq.a6.shareLink": "paginas para compartir",

  "enterprise.title": "IronCode | Soluciones empresariales para tu organizacion",
  "enterprise.meta.description": "Contacta a IronCode para soluciones empresariales",
  "enterprise.hero.title": "Tu codigo es tuyo",
  "enterprise.hero.body1":
    "IronCode opera de forma segura dentro de tu organizacion sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo y luego despliegalo en toda tu organizacion integrandolo con tu SSO y tu gateway interno de IA.",
  ...
  "enterprise.faq.q1": "Que es IronCode Enterprise?",
  "enterprise.faq.a1":
    "IronCode Enterprise es para organizaciones que quieren asegurarse de que su codigo y datos nunca salgan de su infraestructura. Puede lograrlo mediante una configuracion centralizada que se integra con tu SSO y tu gateway interno de IA/LLM.",
  "enterprise.faq.q2": "Como empiezo con IronCode Enterprise?",
  "enterprise.faq.a2":
    "Empieza con una prueba interna con tu equipo. IronCode por defecto no almacena tu codigo ni datos de contexto, lo que facilita comenzar. Despues, contactanos para hablar sobre precios y opciones de implementacion.",
  ...
  "enterprise.faq.q4": "Mis datos estan seguros con IronCode Enterprise?",
  "enterprise.faq.a4":
    "Si. IronCode no almacena tu codigo ni datos de contexto. Todo el procesamiento ocurre localmente o mediante llamadas directas a la API de tu proveedor de IA. Con configuracion centralizada e integracion SSO, tus datos permanecen seguros dentro de la infraestructura de tu organizacion.",

  "brand.title": "IronCode | Marca",
  "brand.meta.description": "Guia de marca de IronCode",
  "brand.heading": "Guia de marca",
  "brand.subtitle": "Recursos y materiales para ayudarte a trabajar con la marca IronCode.",
  "brand.downloadAll": "Descargar todos los recursos",
  "changelog.title": "IronCode | Registro de cambios",
  "changelog.meta.description": "Notas de version y registro de cambios de IronCode",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras de IronCode",
  ...
  "workspace.newUser.feature.lockin.body":
    "Utilice Zen con cualquier agente de codificación y continúe utilizando otros proveedores con ironcode cuando lo desee.",
  ...
  "workspace.newUser.step.login.after": "y seleccione ironcode",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicie ironcode y ejecute",
  ...
  "workspace.keys.subtitle": "Administre sus claves API para acceder a los servicios ironcode.",
  "workspace.keys.create": "Crear clave API",
  "workspace.keys.placeholder": "Introduzca el nombre de la clave",
  "workspace.keys.empty": "Cree una clave ironcode de puerta de enlace API",
  ...
  "workspace.black.subscription.message": "Estás suscrito a IronCode Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan Black de ${{plan}} por mes IronCode.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirlo en el plan Black de ${{plan}} por mes IronCode.",
