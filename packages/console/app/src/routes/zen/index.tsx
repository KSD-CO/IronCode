...
import compareVideo from "../../asset/lander/ironcode-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/ironcode-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="ironcode:auth" content={loggedin() ? "true" : "false"} />
