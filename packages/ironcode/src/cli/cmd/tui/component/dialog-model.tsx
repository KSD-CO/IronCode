          ...
          return [
            {
              ...
              category: "Favorites",
              disabled: provider.id === "ironcode" && model.id.includes("-nano"),
              footer: model.cost?.input === 0 && provider.id === "ironcode" ? "Free" : undefined,
              onSelect: () => {
                dialog.clear()
                local.model.set(
                  {
        ...
        pipe(
          ...
          map(([model, info]) => {
            ...
            return {
              ...
              disabled: provider.id === "ironcode" && model.includes("-nano"),
              footer: info.cost?.input === 0 && provider.id === "ironcode" ? "Free" : undefined,
              onSelect() {
                dialog.clear()
                local.model.set(
                  {
