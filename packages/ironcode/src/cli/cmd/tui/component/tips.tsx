...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a public link to your conversation at ironcode.ai",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/anomalyco/ironcode{/highlight} for containerized use",
