...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ironcode.git")).toEqual({ owner: "sst", repo: "ironcode" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/ironcode")).toEqual({ owner: "sst", repo: "ironcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ironcode.git")).toEqual({ owner: "sst", repo: "ironcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/ironcode")).toEqual({ owner: "sst", repo: "ironcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ironcode.git")).toEqual({ owner: "sst", repo: "ironcode" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/ironcode")).toEqual({ owner: "sst", repo: "ironcode" })
})
