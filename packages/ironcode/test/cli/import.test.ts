...
test("parses valid share URLs", () => {
  expect(parseShareUrl("https://ironcode.cloud/share/Jsj3hNIW")).toBe("Jsj3hNIW")
...
test("rejects invalid URLs", () => {
  expect(parseShareUrl("https://ironcode.cloud/s/Jsj3hNIW")).toBeNull() // legacy format
  expect(parseShareUrl("https://ironcode.cloud/share/")).toBeNull()
  expect(parseShareUrl("https://ironcode.cloud/share/id/extra")).toBeNull()
