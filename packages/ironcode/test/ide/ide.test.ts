...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders IRONCODE_CALLER", () => {
    process.env["IRONCODE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode IRONCODE_CALLER", () => {
    process.env["IRONCODE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown IRONCODE_CALLER", () => {
    process.env["IRONCODE_CALLER"] = "unknown"
