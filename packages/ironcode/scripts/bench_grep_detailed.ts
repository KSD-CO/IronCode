...
console.log(`Pattern: ${pattern}, Search: ${searchPath}${includeGlob ? `, Include: ${includeGlob}` : ''}, Iterations: ${iterations}\n`)
...
console.log(`  avg: ${ffiStats.avg.toFixed(2)}ms, median: ${ffiStats.median.toFixed(2)}ms, p95: ${ffiStats.p95.toFixed(2)}ms`)
...
console.log(`  avg: ${rgStats.avg.toFixed(2)}ms, median: ${rgStats.median.toFixed(2)}ms, p95: ${rgStats.p95.toFixed(2)}ms`)
