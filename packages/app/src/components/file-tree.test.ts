...
beforeAll(async () => {
  ...
  mock.module("@ironcode-ai/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@ironcode-ai/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@ironcode-ai/ui/icon", () => ({ Icon: () => null }))
  mock.module("@ironcode-ai/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
