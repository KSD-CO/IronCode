export const dict = {
  ...
  "dialog.provider.ironcode.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje IronCode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u IronCode-u.",
  ...
  "provider.connect.ironcodeZen.line1":
    "IronCode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u IronCode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u IronCode-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u ironcode.json",
  ...
  "dialog.server.description": "Promijeni na koji se IronCode server ova aplikacija povezuje.",
  ...
  "toast.update.description": "Nova verzija IronCode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku IronCode timu",
  ...
  "error.chain.checkConfig": "Provjeri konfiguraciju (ironcode.json) - nazive provajdera/modela",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: IronCode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "IronCode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u IronCode-u",
  "settings.general.row.appearance.title": "Izgled",
  "settings.general.row.appearance.description": "Prilagodi kako IronCode izgleda na tvom uređaju",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu IronCode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se IronCode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju IronCode-a.",
