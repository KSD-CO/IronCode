...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von IronCode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren {{provider}} API-Schlüssel ein, um Ihr Konto zu verbinden und {{provider}} Modelle in IronCode zu nutzen.",
  ...
  "provider.connect.ironcodeZen.line1":
    "IronCode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.ironcodeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.ironcodeZen.visit.link": "ironcode.ai/zen",
  "provider.connect.ironcodeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}} Modelle in IronCode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}} Modelle in IronCode zu nutzen.",
  ...
  "dialog.plugins.empty": "In ironcode.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den IronCode-Server, mit dem sich diese App verbindet.",
  ...
  "toast.update.description": "Eine neue Version von IronCode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem IronCode-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (ironcode.json) auf Anbieter-/Modellnamen",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: IronCode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "sidebar.gettingStarted.line1": "IronCode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "IronCode Desktop",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für IronCode ändern",
  "settings.general.row.appearance.title": "Erscheinungsbild",
  "settings.general.row.appearance.description": "Anpassen, wie IronCode auf Ihrem Gerät aussieht",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von IronCode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von IronCode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.description": "Du verwendest die aktuelle Version von IronCode.",
