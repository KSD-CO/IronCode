...
export const dict = {
  ...
  "dialog.provider.ironcode.note": "使用 IronCode Zen 或 API 密钥连接",
  ...
  "dialog.model.unpaid.freeModels.title": "IronCode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 IronCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 IronCode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的帐户并在 IronCode 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 ironcode.json 中配置的插件",
  ...
  "dialog.server.description": "切换此应用连接的 IronCode 服务器。",
  ...
  "toast.update.description": "IronCode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 IronCode 团队",
  ...
  "error.chain.checkConfig": "请检查你的配置 (ironcode.json) 中的 provider/model 名称",
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: IronCode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "IronCode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.general.row.language.description": "更改 IronCode 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 IronCode 在你的设备上的外观",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 IronCode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 IronCode 启动时自动检查更新",
