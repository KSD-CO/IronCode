export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo IronCode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no IronCode.",
  ...
  "provider.connect.ironcodeZen.line1":
    "IronCode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.ironcodeZen.visit.prefix": "Visite ",
  "provider.connect.ironcodeZen.visit.link": "ironcode.cloud/zen",
  "provider.connect.ironcodeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no IronCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no IronCode.",
  ...
  "dialog.plugins.empty": "Plugins configurados em ironcode.json",
  ...
  "dialog.server.description": "Trocar para qual servidor IronCode este aplicativo se conecta.",
  ...
  "toast.update.description": "Uma nova versão do IronCode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do IronCode",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (ironcode.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: IronCode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "IronCode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do IronCode",
  "settings.general.row.appearance.title": "Aparência",
  "settings.general.row.appearance.description": "Personalize como o IronCode aparece no seu dispositivo",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o IronCode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o IronCode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do IronCode.",
