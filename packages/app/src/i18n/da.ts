export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af IronCode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din {{provider}} API-nøgle for at forbinde din konto og bruge {{provider}} modeller i IronCode.",
  ...
  "provider.connect.ironcodeZen.line1":
    "IronCode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  "provider.connect.ironcodeZen.line2":
    "Med en enkelt API-nøgle får du adgang til modeller som Claude, GPT, Gemini, GLM og flere.",
  "provider.connect.ironcodeZen.visit.prefix": "Besøg ",
  "provider.connect.ironcodeZen.visit.link": "ironcode.cloud/zen",
  "provider.connect.ironcodeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode for at forbinde din konto og bruge {{provider}} modeller i IronCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge {{provider}} modeller i IronCode.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i ironcode.json",
  ...
  "dialog.server.description": "Skift hvilken IronCode-server denne app forbinder til.",
  ...
  "toast.update.description": "En ny version af IronCode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til IronCode-teamet",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (ironcode.json) udbyder/modelnavne",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, IronCode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "IronCode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for IronCode",
  "settings.general.row.appearance.title": "Udseende",
  "settings.general.row.appearance.description": "Tilpas hvordan IronCode ser ud på din enhed",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas hvordan IronCode er temabestemt.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når IronCode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af IronCode.",
