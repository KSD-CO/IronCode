export const dict = {
  ...
  "dialog.provider.ironcode.note": "Curated models including Claude, GPT, Gemini and more",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by IronCode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in IronCode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.ironcodeZen.line1":
    "IronCode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.ironcodeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.ironcodeZen.visit.prefix": "Visit ",
  "provider.connect.ironcodeZen.visit.link": "ironcode.ai/zen",
  "provider.connect.ironcodeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in IronCode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in IronCode.",
  ...
  "dialog.plugins.empty": "Plugins configured in ironcode.json",
  ...
  "dialog.server.description": "Switch which IronCode server this app connects to.",
  ...
  "toast.update.description": "A new version of IronCode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the IronCode team",
  ...
  "error.chain.checkConfig": "Check your config (ironcode.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, IronCode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "IronCode includes free models so you can start immediately.",
  ...
  "settings.general.row.language.description": "Change the display language for IronCode",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how IronCode looks on your device",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how IronCode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when IronCode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of IronCode.",
