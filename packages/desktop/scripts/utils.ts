...
export const SIDECAR_BINARIES: Array<{ rustTarget: string; ocBinary: string; assetExt: string }> = [
  {
    ...
    ocBinary: "ironcode-darwin-arm64",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-apple-darwin",
    ocBinary: "ironcode-darwin-x64",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-pc-windows-msvc",
    ocBinary: "ironcode-windows-x64",
    assetExt: "zip",
  },
  {
    rustTarget: "x86_64-unknown-linux-gnu",
    ocBinary: "ironcode-linux-x64",
    assetExt: "tar.gz",
  },
  {
    rustTarget: "aarch64-unknown-linux-gnu",
    ocBinary: "ironcode-linux-arm64",
    assetExt: "tar.gz",
  },
]
...
export async function copyBinaryToSidecarFolder(source: string, target = RUST_TARGET) {
  ...
  const dest = windowsify(`src-tauri/sidecars/ironcode-cli-${target}`)
