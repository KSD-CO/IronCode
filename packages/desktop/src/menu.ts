    ...
    items: [
      ...
      await Submenu.new({
        ...
        items: [
          ...
          await MenuItem.new({
            action: () => openUrl("https://discord.com/invite/ironcode"),
            text: "Support Forum",
          }),
          await PredefinedMenuItem.new({
            item: "Separator",
          ...
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/ironcode/issues/new?template=feature_request.yml"),
            text: "Share Feedback",
          }),
          await MenuItem.new({
            action: () => openUrl("https://github.com/anomalyco/ironcode/issues/new?template=bug_report.yml"),
            text: "Report a Bug",
          }),
        ],
      }),
